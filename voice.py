...
def wishMe():
    ...
    if (hour >= 0 and hour < 12):
        ...
        speak("Good Evening")
    speak("I am siri Please tell me how may i help you!!! please mention siri in giving me commands and after completion of one command please press enter")
...
def weather():
    ...
    city = input()
    speak("displaying the weather report of %s"%(city))
